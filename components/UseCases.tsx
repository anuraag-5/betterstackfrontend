...
const UseCases = () => {
  ...
  useEffect(
    () => {
      ...
      tl.to(firstRef.current, { x: width > 1279 ? -400 : width > 1023 ? -300 : -250, y: width > 1279 ? -120 : -80 }, 0);
      tl.to(thirdRef.current, { x: width > 1279 ? 400 : width > 1023 ? 300 : 250, y: width > 1279 ? -120 : -80 }, 0);
    },
    [ width ]
  );
  return (
