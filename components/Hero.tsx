  ...
  return (
    <div className="text-black flex flex-col min-h-screen bg-linear-to-b from-[#C499FF] to-[#745A97] rounded-[12px] md:rounded-[36px] px-4 md:px-4 xl:px-8 2xl:px-24 overflow-x-hidden  max-w-[1600px] max-h-[800px] w-full">
      ...
      >
        <div
          className={
            "px-5 py-1 border-3 border-white rounded-full text-white text-[14px] md:text-[16px] " +
            delaFont.className
          }
        >
          Nexus
      ...
      <div className="flex flex-col lg:flex-row lg:items-center mt-20 justify-between lg:pl-12 xl:pl-20 relative max-w-[1300px] flex-1">
        <motion.div
          className="flex flex-col justify-evenly mb-13 min-h-full max-h-[1200px]"
          initial={{
            y: 10,
          }}
          animate={{
        ...
        >
          ...
          <div className="flex flex-col justify-evenly min-h-[330px]">
            <div className="my-4">
              <div className="text-[30px] md:text-[40px] xl:text-[50px] text-transparent bg-clip-text bg-linear-to-r from-[#ffffff] to-[#c4c4c4]">
                Real-Time
              </div>
              <div className="text-[30px] md:text-[40px] xl:text-[50px] text-transparent bg-clip-text bg-linear-to-r from-[#ffffff] to-[#c4c4c4]">
                Monitoring.
